...
d18Oerr = d18O['error']
d18O_LGa = d18O['d18OLGa']
d18O_LGval = d18O['d18OLGval']

#AR = AquaRegia,  Ch = Chromic, a = age, os = Osmium value, ppt = conct, err = error
...
#Sea level data, a = age, data = data, up = upper bound, lo = lower bound
SLdata = SLsheet['SL']
SLa = SLsheet['Time']
SLup = SLsheet['SL_upper']
SLlo = SLsheet['SL_lower']

#CO2 data, same as Sea level
...
#Create matrix of Os, d18O, and Years
LG_df1 = ch1302[['187Os/188Os']].copy()
LG_df2 = ch1302[['Age Increment']].copy()
LG_df3 = d18O[['d18OLGval']].copy()
LG_df4 = d18O[['d18OLGa']].copy()
LG_df3.dropna(inplace=True)
LG_df4.dropna(inplace=True)
LG_dfd18O = pd.concat([LG_df3, LG_df4], axis=1, join="inner")
LG_dfOs = pd.concat([LG_df1, LG_df2], axis=1, join="inner")
LG_dfMx = pd.concat([LG_df1, LG_df2,LG_df3], axis=1, join="inner")


df = pd.DataFrame(LG_dfMx)
print(df)

fig = plt.figure(figsize = (8, 6))
sns.regplot(data = df, x = 'd18OLGval', y ='187Os/188Os')
plt.show()
...
z = d18O_LGa
#Spearman
corr, _ = spearmanr(LG_dfd18O, LG_dfOs)
...
grangercausalitytests(df[['d18OLGval', '187Os/188Os']], maxlag=[3])
grangercausalitytests(df[['187Os/188Os','d18OLGval']], maxlag=[3])
...
ax1.set_ylim(5.5, 3) 
ax1.set_xlim(450,880) 
ax1.set_ylabel('d18O (LR04)')
ax2.set_ylabel('187Os / 188Os')
ax1.set_xlabel('Age (ka)')
ax2.scatter(ch1308a,ch1308os, facecolors='none', edgecolors='black', marker = None, label = "1308", s = 80)   
ax2.set_ylim(0,2.5)



#MIS labels
ax1.text(499,3.45,'MIS 13',size=15)
ax1.text(543,4.7,'14',size=15)
...
left, bottom, width, height = (450, 0, 41, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (491, 0,44, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (535, 0, 76, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (611, 0, 26, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (637, 0, 61, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (698, 0, 22, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (720, 0, 60, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (780, 0, 22, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (802, 0, 56, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
                        ...
                        linewidth = 2)
plt.gca().add_patch(rect4)
left, bottom, width, height = (858, 0, 22, 2.5)
rect4=mpatches.Rectangle((left,bottom),width,height, 
                        #fill = False,
                        #color = "purple",
                        alpha = 0.2,
...
#%% Line d18O and scatter Os 1308 red and blue-overlayed    -------
#Line d18O and scatter Os 1302
#Zones of red interglacial and blue glacial based on Os##################################
fig = plt.figure(figsize=(10, 4))
ax1 = plt.subplot(111)
...
#plt.title('IODP Site 1302 - Osmium Signature')
ax1.set_ylim(5.5, 3) 
ax1.set_xlim(455,880) 
ax1.set_xticks([450,500,550,600,650,700,750,800,850],['450','500','550','600','650','700','750','800','850'])
ax1.set_ylabel('d18O (LR04)')
ax2.set_ylabel('187Os / 188Os')
ax1.set_xlabel('Age (ka)')
...
#%% 3 columns: of d18o LR04, outset: 1302 and 1308          xxxxx
...
#ax1.get_xaxis().set_visible(False)
ax1.set_ylim(5.5, 3) 
ax1.set_yticks([6,5,4,3],['6','5','4','3'])
#ax1.invert_xaxis()
ax1.set_xlim(0,2000) 
bbox=dict(boxstyle="round", alpha=0.1, color='grey')
...
#left, bottom, width, height = (400, 5.25, 900, -2.3)
#rect4=mpatches.Rectangle((left,bottom),width,height, 
#                        fill = False,
#                        color = "black",
#                        alpha = 0.3,
...
#ax2.legend()
#ax2.set_ylim(0,2)
ax2.set_yticks([0,1,2,3],['0','1','2','3'])
...
#Sea Level
ax111 = plt.subplot(gs[2])
ax111.plot(SLa,SLdata, color='blue', marker = '', linewidth=1, label = "Sea Level")
#ax111.fill_between(x, SLup, SLlo)
ax111.set_xlim(550,878)
ax111.get_xaxis().set_visible(False)
ax111.spines["top"].set_color("white")
ax111.spines["bottom"].set_color("white")
ax111.spines["left"].set_color("black")
...
ax111L = plt.subplot(gs[2])
ax111L.plot(SLa,SLup, color='blue', marker = '', linewidth=0.5, label = "Sea Level")
ax111L.set_xlim(550,878)
ax111L.get_xaxis().set_visible(False)
ax111L.spines["top"].set_color("white")
ax111L.spines["bottom"].set_color("white")
ax111L.spines["left"].set_color("black")
...
ax1111 = plt.subplot(gs[3])
ax1111.get_xaxis().set_visible(True)
ax1111.set_xlim(550,878)
ax1111.plot(CO2a,CO2data, color='red', marker = '', linewidth=1, label = "pCO2")
ax1111.yaxis.set_ticks_position('right')
ax1111.yaxis.set_label_position("right")
ax1111.spines["top"].set_color("white")
...
ax1111u = plt.subplot(gs[3])
ax1111u.get_xaxis().set_visible(True)
ax1111u.set_xlim(550,878)
ax1111u.plot(CO2a,CO2up, color='red', marker = '', linewidth=0.5, label = "pCO2")
ax1111u.yaxis.set_ticks_position('right')
ax1111u.yaxis.set_label_position("right")
ax1111u.spines["top"].set_color("white")
...
ax1111L = plt.subplot(gs[3])
ax1111L.get_xaxis().set_visible(True)
ax1111L.set_xlim(550,878)
ax1111L.plot(CO2a,CO2lo, color='red', marker = '', linewidth=0.5, label = "pCO2")
ax1111L.yaxis.set_ticks_position('right')
ax1111L.yaxis.set_label_position("right")
ax1111L.spines["top"].set_color("white")
